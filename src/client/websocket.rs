...
impl BinancexWebsocket {
    ...
    pub async fn subscribe(&mut self, subscription: Subscription) -> Result<(), Error> {
...
impl Stream for BinancexWebsocket {
    type Item = Result<BinanceWebsocketMessage, BinancexError>;
...
fn parse_message(sub: Subscription, ws_message: Message) -> Result<BinanceWebsocketMessage, BinancexError> {
